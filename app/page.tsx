    ...
    <main style={{ fontFamily: 'sans-serif', margin: 0, padding: 0 }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '8px' }}>
          {['Scholarships', 'By Country', 'By Field', 'Forum', 'Blog'].map(item => (
            <a key={item} href="#" style={{
              padding: '7px 13px', borderRadius: '8px', textDecoration: 'none',
              color: '#6b8a72', fontSize: '13px', fontWeight: 500
            }}>{item}</a>
          ))}
        </div>
        <div style={{ display: 'flex', gap: '10px' }}>
          <button style={{
            padding: '8px 18px', borderRadius: '8px', border: '1.5px solid #1a6b3c',
            background: 'transparent', color: '#1a6b3c', fontSize: '13px',
      ...
      {/* HERO */}
      <section style={{
        background: 'linear-gradient(135deg, #0d1f14 0%, #0f3320 50%, #1a5c35 100%)',
        padding: '80px 40px', display: 'flex', justifyContent: 'center'
      }}>
        <div style={{ maxWidth: '700px', textAlign: 'center' }}>
          <div style={{
            display: 'inline-block', padding: '6px 16px',
            background: 'rgba(201,168,76,0.15)', border: '1px solid rgba(201,168,76,0.4)',
            borderRadius: '100px', color: '#f0d080', fontSize: '12px',
            fontWeight: 600, marginBottom: '20px', textTransform: 'uppercase', letterSpacing: '0.5px'
          }}>Africa&apos;s #1 Scholarship Platform</div>

          <h1 style={{
            fontFamily: 'Georgia, serif', fontSize: '48px', fontWeight: 900,
            color: '#fff', lineHeight: 1.1, marginBottom: '20px'
          }}>
            Find Your <em style={{ color: '#f0d080', fontStyle: 'italic' }}>Dream</em> Scholarship Worldwide
          </h1>

          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '16px', lineHeight: 1.7, marginBottom: '32px' }}>
            Discover thousands of fully funded scholarships for African students from top universities across the USA, UK, China, Germany and beyond.
          </p>
          ...
          <div style={{
            ...
            <select style={{
              ...
              fontSize: '13px', color: '#6b8a72', background: '#f8faf9',
              borderRight: '1px solid #e0ece4', minWidth: '130px', cursor: 'pointer'
            }}>
            ...
            <input
              ...
              style={{
                ...
                fontSize: '14px', color: '#1a2e1f'
              }}
            />
            <button style={{
              padding: '14px 24px', background: '#1a6b3c', border: 'none',
      ...
      <section style={{ padding: '60px 40px', maxWidth: '1200px', margin: '0 auto' }}>
        <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', fontWeight: 700, marginBottom: '8px', color: '#1a2e1f' }}>
          Browse by <span style={{ color: '#1a6b3c' }}>Field of Study</span>
        </h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '16px' }}>
          {[
            ...
            <div key={name} style={{
              background: '#f4f7f5', borderRadius: '14px', padding: '20px 14px',
      ...
      <section style={{ background: '#f4f7f5', padding: '60px 40px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '32px', fontWeight: 700, marginBottom: '8px', color: '#1a2e1f' }}>
            Latest <span style={{ color: '#1a6b3c' }}>Scholarships</span>
          </h2>
          <p style={{ color: '#6b8a72', marginBottom: '28px', fontSize: '14px' }}>Updated daily — auto-fetched from top universities worldwide</p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '24px' }}>
            {[
              ...
              <div key={s.title} style={{
                ...
                border: '1px solid #e8f0eb', boxShadow: '0 2px 12px rgba(26,107,60,0.04)'
              }}>
      ...
      <footer style={{ background: '#0d1f14', color: 'rgba(255,255,255,0.6)', padding: '40px', textAlign: 'center' }}>
        <div style={{ fontFamily: 'Georgia, serif', fontSize: '18px', fontWeight: 700, color: '#fff', marginBottom: '8px' }}>
          🎓 World<span style={{ color: '#c9a84c' }}>Scholarships</span>Africa
        </div>
